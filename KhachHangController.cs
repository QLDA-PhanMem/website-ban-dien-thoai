...
namespace ITShop.Controllers
{
    ...
    public class KhachHangController : Controller
    {
        ...
        public IActionResult DatHang()
        {
            ...
            var gioHang = gioHangLogic.LayGioHang(); decimal tongTien = gioHangLogic.LayTongTienSanPham();
        ...
        public async Task<IActionResult> DatHang(DatHang datHang)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    mailInfo.Subject = "Đặt hàng thành công tại ITShop.Com.Vn"; var datHangInfo = _context.DatHang.Where(r => r.ID == dh.ID)
